...
def get_fixtures() -> dict:
    ...
    return  {
        'photometry_signal_pqt': data_folder / session_folder / Path('alf/photometry/photometry.signal.pqt'),
        'photometryROI_locations_pqt': data_folder / session_folder / Path('alf/photometry/photometryROI.locations.pqt'),
        'raw_neurophotometrics_pqt': data_folder/ session_folder / Path('raw_photometry_data/_neurophotometrics_fpData.raw.pqt'),
